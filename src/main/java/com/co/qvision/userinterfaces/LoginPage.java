...
public class LoginPage {
    public static final Target BTN_ACCOUNT = Target.the("Botón opción acceder a inicio de sesión")
            .located(By.xpath("//div[@class= 'myaccount']/a"));
    ...
    public static final Target TXT_VERIFYIDENTIFICATION = Target.the("Campo de texto para verificar inicio de sesión exitoso")
            .located(By.xpath("//div[@class = 'woocommerce-MyAccount-content']/p[1]/strong[1]"));
